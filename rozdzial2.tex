...
Jednym z bardziej znanych środowisk do składania dokumentów  \LaTeX a jest {\em TeXstudio}, oferujące kompletne środowisko pracy. Zobacz: \url{http://www.texstudio.org}. Wygodnym narzędziem jest również Visual Studio Code.
...
Wygodnym narzędziem online do pracy nad dokumentem w \LaTeX u jest \em{Overleaf} (zobacz: \url{https://www.overleaf.com}). Umożliwia on tworzenie, edytowanie i kompilację dokumentów \LaTeX owych bez konieczności instalowania jakiegokolwiek oprogramowania na komputerze użytkownika. Overleaf oferuje również współpracę zespołową w czasie rzeczywistym (w tym komentarze i śledzenie zmian) oraz synchronizację z repozytorium GitHub.
...
\begin{itemize}
\item
Nie stosujemy w kodzie znaków innych niż podstawowe, dostępne z klawiatury. Wszystkie symbole matematyczne, litery grecki, potęgi itp. wykonujemy przy użyciu odpowiednich komend.
...
\item
Znakiem końca akapitu jest pusta linia (ilość pustych linii nie ma znaczenia), a
