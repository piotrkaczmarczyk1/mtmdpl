...
Pakiet \texttt{subcaption} pozwala na umieszczanie w podpisie rysunku odnośników do ,,podilustracji''. Przykład jego zastosowania prezentuje rys.~\ref{fig:subfigure_example}. Do ,,podilustracji'' z rys.~\ref{subfig:a} można odwołać się także w tekście. Analogicznie jest w przypadku drugiej ,,podilustracji'' [rys.~\ref{subfig:b}].
...
\begin{figure}[h]
	...
	\caption{Przykład użycia \texttt{\textbackslash subfigure}: \subref{subfig:a} litera A, \subref{subfig:b} litera B.}
